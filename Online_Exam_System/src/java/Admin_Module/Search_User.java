...
public class Search_User extends HttpServlet {
        ...
        try 
        {
            ...
            out.println("<div style='width:900px;height:450px;'>"
                    ...
                    out.println("<form action=Show_Student>"
                            + "<table width=500px border=0>"
                            + "<br><br><br><br><br><br><h2><u>Search Particular Student Record</u></h2>"
                    + "<tr height=40 style='font-size:20px;'><th width=200px>Enter UserId</th>"
                    + "<td><input type=email name=user_id  style='text-align:center;width:250px;height:25px;'placeholder='Enter Your Email '></td></tr>"
                    + "<tr height=30px><th colspan=2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
                            + "<input type=submit value=SHOW style='font-size:15px'>&nbsp;&nbsp;&nbsp;&nbsp;"
