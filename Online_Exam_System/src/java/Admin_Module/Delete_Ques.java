 ...
 */
public class Delete_Ques extends HttpServlet 
{
            ...
            throws ServletException, IOException 
     {
        ...
        try 
        {
            ...
            out.println("<div style='width:900px;height:180px;background-image:url(Images/adminBanner.jpg);'></div>"
                    ...
                    + "<marquee direction=right  scrollamount='5' style='color:crimson;font-weight:bold;font-family:times new roman;'>"
                    +"<a href='View_User_Detail' style='text-decoration:none;'>View New Registerd Student</a></marquee></div>"
              ...
              out.println("<div style='width:900px;height:450px;'>"
                    ...
                    + "font-size:15px;color:white;border-style:grove;background-color:#CCCCCC;'>"
                    ...
                    out.println("<form action=Delete_Ques_Conf>"
                            + "<table width=500px border=0>"
                            + "<br><br><br><br><br><br><h2><u>Delete Particular Question</u></h2>"
                            + "<tr height=40 style='font-size:20px;'><th width=200px>Question Id</th>"
                            + "<td><input type=text name=id  style='text-align:center;width:250px;height:25px;'placeholder='Enter Question Id to be Deleted 'required></td></tr>"
                            + "<tr height=30px><th colspan=2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
                            + "<input type=submit value=Delete style='font-size:15px'>&nbsp;&nbsp;&nbsp;&nbsp;"
                            + "<input type=reset value=Clear style='font-size:15px'></th></tr></table></form>"
                    + "</div></div>");
